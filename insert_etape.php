...
$username = "root";
$password = "";
// Faire un mode de connection avec un gitignore pour éviter de mettre tout ce pavé a chaque page qui a besoin de se connecter (quasiment toutes les pages)
try {
